    ...
    <div className="max-w-[1124px] mx-auto h-screen grid grid-cols-2 items-center gap-28" >
      <main>
        ...
        <form className="mt-10 flex gap-2">
          ...
          <button
            className="bg-yellow-500 px-6 py-4 rounded text-sm font-bold text-gray-950 uppercase hover:bg-yellow-700"
            type="submit"
          >
            Criar meu bolão
          </button>
...
export const getServerSideProps = async () => {
  ...
  return {
    props: {
      poolCount: poolCountResponse.data.countAllPools,
      guessCount: guessCountResponse.data.countAllGuesses,
      userCount: usersCountResponse.data.countAllUsers,
    }
  }
}